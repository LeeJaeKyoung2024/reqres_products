pipeline {
    ...
    environment {
        REGISTRY = 'user21.azurecr.io'
        IMAGE_NAME = 'product'
        AKS_CLUSTER = 'user21-aks'
        RESOURCE_GROUP = 'user21-rsrcgrp'
        AKS_NAMESPACE = 'default'
        AZURE_CREDENTIALS_ID = 'Azure-Cred'
        TENANT_ID = '9770b5ac-a88b-4354-aeb7-70f930947ea9' // Service Principal 등록 후 생성된 ID
    }
